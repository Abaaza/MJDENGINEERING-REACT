    ...
    <header className="flex items-center justify-between mb-6">
      ...
      <Menu as="div" className="relative">
        <Menu.Button className="flex items-center gap-2 select-none">
          <UserCircleIcon className="h-7 w-7 text-brand-dark" />
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg focus:outline-none p-1">
            <Menu.Item>
              {({ active }) => (
                <button
